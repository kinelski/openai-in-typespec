...
namespace OpenAI.Responses
{
    ...
    {
        internal StreamingResponseFileSearchCallInProgressUpdate() : this(InternalResponseStreamEventType.ResponseFileSearchCallInProgress, null, default, null)
        {
        }
        ...
        internal static StreamingResponseFileSearchCallInProgressUpdate DeserializeStreamingResponseFileSearchCallInProgressUpdate(JsonElement element, ModelReaderWriterOptions options)
        {
            ...
            return new StreamingResponseFileSearchCallInProgressUpdate(kind, additionalBinaryDataProperties, outputIndex, itemId);
        }
