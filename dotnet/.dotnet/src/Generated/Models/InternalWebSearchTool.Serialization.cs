...
namespace OpenAI.Responses
{
    internal partial class InternalWebSearchTool : IJsonModel<InternalWebSearchTool>
    {
        ...
        public static implicit operator BinaryContent(InternalWebSearchTool internalWebSearchTool)
        {
            if (internalWebSearchTool == null)
            {
                return null;
            }
            return BinaryContent.Create(internalWebSearchTool, ModelSerializationExtensions.WireOptions);
        }

        public static explicit operator InternalWebSearchTool(ClientResult result)
        {
            using PipelineResponse response = result.GetRawResponse();
            using JsonDocument document = JsonDocument.Parse(response.Content);
            return DeserializeInternalWebSearchTool(document.RootElement, ModelSerializationExtensions.WireOptions);
        }
    }
}
