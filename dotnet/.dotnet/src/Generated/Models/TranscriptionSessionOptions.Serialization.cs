...
namespace OpenAI.Realtime
{
    public partial class TranscriptionSessionOptions : IJsonModel<TranscriptionSessionOptions>
    {
        ...
        {
            if (transcriptionSessionOptions == null)
            {
                return null;
            }
            return BinaryContent.Create(transcriptionSessionOptions, ModelSerializationExtensions.WireOptions);
        }
        ...
        public static explicit operator TranscriptionSessionOptions(ClientResult result)
        {
            ...
            return DeserializeTranscriptionSessionOptions(document.RootElement, ModelSerializationExtensions.WireOptions);
        }
    }
}
