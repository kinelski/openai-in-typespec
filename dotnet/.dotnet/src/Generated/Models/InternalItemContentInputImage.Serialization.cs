...
namespace OpenAI.Responses
{
    internal partial class InternalItemContentInputImage : IJsonModel<InternalItemContentInputImage>
    {
        ...
        public static implicit operator BinaryContent(InternalItemContentInputImage internalItemContentInputImage)
        {
            if (internalItemContentInputImage == null)
            {
                return null;
            }
            return BinaryContent.Create(internalItemContentInputImage, ModelSerializationExtensions.WireOptions);
        }

        public static explicit operator InternalItemContentInputImage(ClientResult result)
        {
            using PipelineResponse response = result.GetRawResponse();
            using JsonDocument document = JsonDocument.Parse(response.Content);
            return DeserializeInternalItemContentInputImage(document.RootElement, ModelSerializationExtensions.WireOptions);
        }
    }
}
