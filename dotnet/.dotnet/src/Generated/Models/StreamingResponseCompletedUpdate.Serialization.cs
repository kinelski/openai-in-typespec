...
namespace OpenAI.Responses
{
    ...
    {
        internal StreamingResponseCompletedUpdate() : this(InternalResponseStreamEventType.ResponseCompleted, null, null)
        {
        }
        ...
        internal static StreamingResponseCompletedUpdate DeserializeStreamingResponseCompletedUpdate(JsonElement element, ModelReaderWriterOptions options)
        {
            ...
            return new StreamingResponseCompletedUpdate(kind, additionalBinaryDataProperties, response);
        }
