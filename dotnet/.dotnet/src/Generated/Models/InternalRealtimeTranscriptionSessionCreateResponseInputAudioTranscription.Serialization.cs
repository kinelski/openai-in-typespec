...
namespace OpenAI.Realtime
{
    internal partial class InternalRealtimeTranscriptionSessionCreateResponseInputAudioTranscription : IJsonModel<InternalRealtimeTranscriptionSessionCreateResponseInputAudioTranscription>
    {
        ...
        public static implicit operator BinaryContent(InternalRealtimeTranscriptionSessionCreateResponseInputAudioTranscription internalRealtimeTranscriptionSessionCreateResponseInputAudioTranscription)
        {
            if (internalRealtimeTranscriptionSessionCreateResponseInputAudioTranscription == null)
            {
                return null;
            }
            return BinaryContent.Create(internalRealtimeTranscriptionSessionCreateResponseInputAudioTranscription, ModelSerializationExtensions.WireOptions);
        }

        public static explicit operator InternalRealtimeTranscriptionSessionCreateResponseInputAudioTranscription(ClientResult result)
        {
            using PipelineResponse response = result.GetRawResponse();
            using JsonDocument document = JsonDocument.Parse(response.Content);
            return DeserializeInternalRealtimeTranscriptionSessionCreateResponseInputAudioTranscription(document.RootElement, ModelSerializationExtensions.WireOptions);
        }
    }
}
