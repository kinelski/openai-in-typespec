...
namespace OpenAI.Realtime
{
    public partial class InputAudioTranscriptionFailedUpdate : IJsonModel<InputAudioTranscriptionFailedUpdate>
    {
        ...
        {
            if (inputAudioTranscriptionFailedUpdate == null)
            {
                return null;
            }
            return BinaryContent.Create(inputAudioTranscriptionFailedUpdate, ModelSerializationExtensions.WireOptions);
        }

        public static explicit operator InputAudioTranscriptionFailedUpdate(ClientResult result)
        {
            using PipelineResponse response = result.GetRawResponse();
            using JsonDocument document = JsonDocument.Parse(response.Content);
            return DeserializeInputAudioTranscriptionFailedUpdate(document.RootElement, ModelSerializationExtensions.WireOptions);
        }
    }
}
