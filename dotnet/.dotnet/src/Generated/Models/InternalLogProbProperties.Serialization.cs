...
namespace OpenAI.Internal
{
    internal partial class InternalLogProbProperties : IJsonModel<InternalLogProbProperties>
    {
        ...
        public static implicit operator BinaryContent(InternalLogProbProperties internalLogProbProperties)
        {
            if (internalLogProbProperties == null)
            {
                return null;
            }
            return BinaryContent.Create(internalLogProbProperties, ModelSerializationExtensions.WireOptions);
        }

        public static explicit operator InternalLogProbProperties(ClientResult result)
        {
            using PipelineResponse response = result.GetRawResponse();
            using JsonDocument document = JsonDocument.Parse(response.Content);
            return DeserializeInternalLogProbProperties(document.RootElement, ModelSerializationExtensions.WireOptions);
        }
    }
}
