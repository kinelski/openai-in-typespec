...
namespace OpenAI.Responses
{
    internal partial class InternalComputerActionDrag : IJsonModel<InternalComputerActionDrag>
    {
        ...
        public static implicit operator BinaryContent(InternalComputerActionDrag internalComputerActionDrag)
        {
            if (internalComputerActionDrag == null)
            {
                return null;
            }
            return BinaryContent.Create(internalComputerActionDrag, ModelSerializationExtensions.WireOptions);
        }

        public static explicit operator InternalComputerActionDrag(ClientResult result)
        {
            using PipelineResponse response = result.GetRawResponse();
            using JsonDocument document = JsonDocument.Parse(response.Content);
            return DeserializeInternalComputerActionDrag(document.RootElement, ModelSerializationExtensions.WireOptions);
        }
    }
}
