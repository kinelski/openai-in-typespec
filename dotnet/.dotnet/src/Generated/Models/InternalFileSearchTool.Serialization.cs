...
namespace OpenAI.Responses
{
    internal partial class InternalFileSearchTool : IJsonModel<InternalFileSearchTool>
    {
        ...
        public static implicit operator BinaryContent(InternalFileSearchTool internalFileSearchTool)
        {
            if (internalFileSearchTool == null)
            {
                return null;
            }
            return BinaryContent.Create(internalFileSearchTool, ModelSerializationExtensions.WireOptions);
        }

        public static explicit operator InternalFileSearchTool(ClientResult result)
        {
            using PipelineResponse response = result.GetRawResponse();
            using JsonDocument document = JsonDocument.Parse(response.Content);
            return DeserializeInternalFileSearchTool(document.RootElement, ModelSerializationExtensions.WireOptions);
        }
    }
}
