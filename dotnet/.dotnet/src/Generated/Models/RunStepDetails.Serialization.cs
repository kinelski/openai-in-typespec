...
namespace OpenAI.Assistants
{
    ...
    public abstract partial class RunStepDetails : IJsonModel<RunStepDetails>
    {
        ...
        {
            if (runStepDetails == null)
            {
                return null;
            }
            return BinaryContent.Create(runStepDetails, ModelSerializationExtensions.WireOptions);
        }
        ...
        public static explicit operator RunStepDetails(ClientResult result)
        {
            ...
            return DeserializeRunStepDetails(document.RootElement, ModelSerializationExtensions.WireOptions);
        }
    }
}
