...
namespace OpenAI.Realtime
{
    internal partial class InternalRealtimeTranscriptionSessionCreateResponse : IJsonModel<InternalRealtimeTranscriptionSessionCreateResponse>
    {
        ...
        public static implicit operator BinaryContent(InternalRealtimeTranscriptionSessionCreateResponse internalRealtimeTranscriptionSessionCreateResponse)
        {
            if (internalRealtimeTranscriptionSessionCreateResponse == null)
            {
                return null;
            }
            return BinaryContent.Create(internalRealtimeTranscriptionSessionCreateResponse, ModelSerializationExtensions.WireOptions);
        }
