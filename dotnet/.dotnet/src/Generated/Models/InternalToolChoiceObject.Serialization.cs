...
namespace OpenAI.Responses
{
    ...
    internal abstract partial class InternalToolChoiceObject : IJsonModel<InternalToolChoiceObject>
    {
        ...
        public static implicit operator BinaryContent(InternalToolChoiceObject internalToolChoiceObject)
        {
            if (internalToolChoiceObject == null)
            {
                return null;
            }
            return BinaryContent.Create(internalToolChoiceObject, ModelSerializationExtensions.WireOptions);
        }

        public static explicit operator InternalToolChoiceObject(ClientResult result)
        {
            using PipelineResponse response = result.GetRawResponse();
            using JsonDocument document = JsonDocument.Parse(response.Content);
            return DeserializeInternalToolChoiceObject(document.RootElement, ModelSerializationExtensions.WireOptions);
        }
    }
}
