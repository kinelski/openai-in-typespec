...
namespace OpenAI.Responses
{
    internal partial class InternalComparisonFilterGreaterThan : IJsonModel<InternalComparisonFilterGreaterThan>
    {
        ...
        public static implicit operator BinaryContent(InternalComparisonFilterGreaterThan internalComparisonFilterGreaterThan)
        {
            if (internalComparisonFilterGreaterThan == null)
            {
                return null;
            }
            return BinaryContent.Create(internalComparisonFilterGreaterThan, ModelSerializationExtensions.WireOptions);
        }

        public static explicit operator InternalComparisonFilterGreaterThan(ClientResult result)
        {
            using PipelineResponse response = result.GetRawResponse();
            using JsonDocument document = JsonDocument.Parse(response.Content);
            return DeserializeInternalComparisonFilterGreaterThan(document.RootElement, ModelSerializationExtensions.WireOptions);
        }
    }
}
