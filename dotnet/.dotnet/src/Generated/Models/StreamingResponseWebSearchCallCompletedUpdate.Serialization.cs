...
namespace OpenAI.Responses
{
    ...
    {
        internal StreamingResponseWebSearchCallCompletedUpdate() : this(InternalResponseStreamEventType.ResponseWebSearchCallCompleted, null, default, null)
        {
        }
        ...
        internal static StreamingResponseWebSearchCallCompletedUpdate DeserializeStreamingResponseWebSearchCallCompletedUpdate(JsonElement element, ModelReaderWriterOptions options)
        {
            ...
            return new StreamingResponseWebSearchCallCompletedUpdate(kind, additionalBinaryDataProperties, outputIndex, itemId);
        }
