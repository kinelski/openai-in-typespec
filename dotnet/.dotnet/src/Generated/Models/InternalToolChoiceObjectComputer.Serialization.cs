...
namespace OpenAI.Responses
{
    internal partial class InternalToolChoiceObjectComputer : IJsonModel<InternalToolChoiceObjectComputer>
    {
        ...
        public static implicit operator BinaryContent(InternalToolChoiceObjectComputer internalToolChoiceObjectComputer)
        {
            if (internalToolChoiceObjectComputer == null)
            {
                return null;
            }
            return BinaryContent.Create(internalToolChoiceObjectComputer, ModelSerializationExtensions.WireOptions);
        }

        public static explicit operator InternalToolChoiceObjectComputer(ClientResult result)
        {
            using PipelineResponse response = result.GetRawResponse();
            using JsonDocument document = JsonDocument.Parse(response.Content);
            return DeserializeInternalToolChoiceObjectComputer(document.RootElement, ModelSerializationExtensions.WireOptions);
        }
    }
}
