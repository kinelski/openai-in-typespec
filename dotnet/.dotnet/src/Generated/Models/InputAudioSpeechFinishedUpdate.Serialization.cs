...
namespace OpenAI.Realtime
{
    public partial class InputAudioSpeechFinishedUpdate : IJsonModel<InputAudioSpeechFinishedUpdate>
    {
        ...
        {
            if (inputAudioSpeechFinishedUpdate == null)
            {
                return null;
            }
            return BinaryContent.Create(inputAudioSpeechFinishedUpdate, ModelSerializationExtensions.WireOptions);
        }

        public static explicit operator InputAudioSpeechFinishedUpdate(ClientResult result)
        {
            using PipelineResponse response = result.GetRawResponse();
            using JsonDocument document = JsonDocument.Parse(response.Content);
            return DeserializeInputAudioSpeechFinishedUpdate(document.RootElement, ModelSerializationExtensions.WireOptions);
        }
    }
}
