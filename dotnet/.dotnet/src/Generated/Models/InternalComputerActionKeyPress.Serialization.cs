...
namespace OpenAI.Responses
{
    internal partial class InternalComputerActionKeyPress : IJsonModel<InternalComputerActionKeyPress>
    {
        ...
        public static implicit operator BinaryContent(InternalComputerActionKeyPress internalComputerActionKeyPress)
        {
            if (internalComputerActionKeyPress == null)
            {
                return null;
            }
            return BinaryContent.Create(internalComputerActionKeyPress, ModelSerializationExtensions.WireOptions);
        }

        public static explicit operator InternalComputerActionKeyPress(ClientResult result)
        {
            using PipelineResponse response = result.GetRawResponse();
            using JsonDocument document = JsonDocument.Parse(response.Content);
            return DeserializeInternalComputerActionKeyPress(document.RootElement, ModelSerializationExtensions.WireOptions);
        }
    }
}
