...
namespace OpenAI.Realtime
{
    public partial class InputAudioCommittedUpdate : IJsonModel<InputAudioCommittedUpdate>
    {
        ...
        {
            if (inputAudioCommittedUpdate == null)
            {
                return null;
            }
            return BinaryContent.Create(inputAudioCommittedUpdate, ModelSerializationExtensions.WireOptions);
        }

        public static explicit operator InputAudioCommittedUpdate(ClientResult result)
        {
            using PipelineResponse response = result.GetRawResponse();
            using JsonDocument document = JsonDocument.Parse(response.Content);
            return DeserializeInputAudioCommittedUpdate(document.RootElement, ModelSerializationExtensions.WireOptions);
        }
    }
}
