...
namespace OpenAI.Responses
{
    internal partial class InternalComputerActionScreenshot : IJsonModel<InternalComputerActionScreenshot>
    {
        ...
        public static implicit operator BinaryContent(InternalComputerActionScreenshot internalComputerActionScreenshot)
        {
            if (internalComputerActionScreenshot == null)
            {
                return null;
            }
            return BinaryContent.Create(internalComputerActionScreenshot, ModelSerializationExtensions.WireOptions);
        }

        public static explicit operator InternalComputerActionScreenshot(ClientResult result)
        {
            using PipelineResponse response = result.GetRawResponse();
            using JsonDocument document = JsonDocument.Parse(response.Content);
            return DeserializeInternalComputerActionScreenshot(document.RootElement, ModelSerializationExtensions.WireOptions);
        }
    }
}
