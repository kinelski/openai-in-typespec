...
namespace OpenAI.Responses
{
    ...
    {
        internal StreamingResponseInProgressUpdate() : this(InternalResponseStreamEventType.ResponseInProgress, null, null)
        {
        }
        ...
        internal static StreamingResponseInProgressUpdate DeserializeStreamingResponseInProgressUpdate(JsonElement element, ModelReaderWriterOptions options)
        {
            ...
            return new StreamingResponseInProgressUpdate(kind, additionalBinaryDataProperties, response);
        }
        ...
        {
            if (streamingResponseInProgressUpdate == null)
            {
                return null;
            }
            return BinaryContent.Create(streamingResponseInProgressUpdate, ModelSerializationExtensions.WireOptions);
        }

        public static explicit operator StreamingResponseInProgressUpdate(ClientResult result)
        {
            using PipelineResponse response = result.GetRawResponse();
            using JsonDocument document = JsonDocument.Parse(response.Content);
            return DeserializeStreamingResponseInProgressUpdate(document.RootElement, ModelSerializationExtensions.WireOptions);
        }
    }
}
