...
{
    internal partial class InternalUnknownComputerToolCallOutputOutput : IJsonModel<ComputerOutput>
    {
        internal InternalUnknownComputerToolCallOutputOutput() : this(default, null)
        {
        }
        ...
        internal static InternalUnknownComputerToolCallOutputOutput DeserializeInternalUnknownComputerToolCallOutputOutput(JsonElement element, ModelReaderWriterOptions options)
        {
            ...
            return new InternalUnknownComputerToolCallOutputOutput(kind, additionalBinaryDataProperties);
        }
