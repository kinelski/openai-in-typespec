...
namespace OpenAI.Responses
{
    ...
    {
        internal ReasoningResponseItem() : this(InternalItemType.Reasoning, null, null, default, null)
        {
        }
        ...
        protected override void JsonModelWriteCore(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (_additionalBinaryDataProperties?.ContainsKey("summary") != true)
            {
                ...
                foreach (InternalReasoningItemSummaryText item in Summary)
                {
        ...
        internal static ReasoningResponseItem DeserializeReasoningResponseItem(JsonElement element, ModelReaderWriterOptions options)
        {
            ...
            IList<InternalReasoningItemSummaryText> summary = default;
            foreach (var prop in element.EnumerateObject())
            {
                ...
                {
                    List<InternalReasoningItemSummaryText> array = new List<InternalReasoningItemSummaryText>();
                    foreach (var item in prop.Value.EnumerateArray())
                    {
                        array.Add(InternalReasoningItemSummaryText.DeserializeInternalReasoningItemSummaryText(item, options));
                    }
                    summary = array;
                    continue;
                }
            ...
            return new ReasoningResponseItem(kind, id, additionalBinaryDataProperties, status, summary);
        }
