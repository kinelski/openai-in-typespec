...
namespace OpenAI.Chat
{
    public partial class ChatMessageAnnotation : IJsonModel<ChatMessageAnnotation>
    {
        ...
        internal static ChatMessageAnnotation DeserializeChatMessageAnnotation(JsonElement element, ModelReaderWriterOptions options)
        {
            ...
            InternalChatCompletionResponseMessageAnnotationType kind = default;
            ...
            foreach (var prop in element.EnumerateObject())
            {
                ...
                {
                    kind = new InternalChatCompletionResponseMessageAnnotationType(prop.Value.GetString());
                    continue;
                }
            ...
            return new ChatMessageAnnotation(kind, urlCitation, additionalBinaryDataProperties);
        }
