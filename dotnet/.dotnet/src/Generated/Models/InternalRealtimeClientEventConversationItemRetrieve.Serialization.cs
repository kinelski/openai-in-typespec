...
namespace OpenAI.Realtime
{
    internal partial class InternalRealtimeClientEventConversationItemRetrieve : IJsonModel<InternalRealtimeClientEventConversationItemRetrieve>
    {
        ...
        public static implicit operator BinaryContent(InternalRealtimeClientEventConversationItemRetrieve internalRealtimeClientEventConversationItemRetrieve)
        {
            if (internalRealtimeClientEventConversationItemRetrieve == null)
            {
                return null;
            }
            return BinaryContent.Create(internalRealtimeClientEventConversationItemRetrieve, ModelSerializationExtensions.WireOptions);
        }

        public static explicit operator InternalRealtimeClientEventConversationItemRetrieve(ClientResult result)
        {
            using PipelineResponse response = result.GetRawResponse();
            using JsonDocument document = JsonDocument.Parse(response.Content);
            return DeserializeInternalRealtimeClientEventConversationItemRetrieve(document.RootElement, ModelSerializationExtensions.WireOptions);
        }
    }
}
