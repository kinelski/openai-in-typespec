...
namespace OpenAI.Chat
{
    internal partial class InternalDotNetChatResponseFormatJsonSchema : IJsonModel<InternalDotNetChatResponseFormatJsonSchema>
    {
        ...
        public static implicit operator BinaryContent(InternalDotNetChatResponseFormatJsonSchema internalDotNetChatResponseFormatJsonSchema)
        {
            if (internalDotNetChatResponseFormatJsonSchema == null)
            {
                return null;
            }
            return BinaryContent.Create(internalDotNetChatResponseFormatJsonSchema, ModelSerializationExtensions.WireOptions);
        }

        public static explicit operator InternalDotNetChatResponseFormatJsonSchema(ClientResult result)
        {
            using PipelineResponse response = result.GetRawResponse();
            using JsonDocument document = JsonDocument.Parse(response.Content);
            return DeserializeInternalDotNetChatResponseFormatJsonSchema(document.RootElement, ModelSerializationExtensions.WireOptions);
        }
    }
}
