...
namespace OpenAI.Chat
{
    internal readonly partial struct InternalCreateChatCompletionResponseServiceTier : IEquatable<InternalCreateChatCompletionResponseServiceTier>
    {
        ...
        internal static InternalCreateChatCompletionResponseServiceTier Scale { get; } = new InternalCreateChatCompletionResponseServiceTier(ScaleValue);

        internal static InternalCreateChatCompletionResponseServiceTier Default { get; } = new InternalCreateChatCompletionResponseServiceTier(DefaultValue);
