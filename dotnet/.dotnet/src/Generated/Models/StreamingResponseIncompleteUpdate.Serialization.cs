...
namespace OpenAI.Responses
{
    ...
    {
        internal StreamingResponseIncompleteUpdate() : this(InternalResponseStreamEventType.ResponseIncomplete, null, null)
        {
        }
        ...
        internal static StreamingResponseIncompleteUpdate DeserializeStreamingResponseIncompleteUpdate(JsonElement element, ModelReaderWriterOptions options)
        {
            ...
            return new StreamingResponseIncompleteUpdate(kind, additionalBinaryDataProperties, response);
        }
