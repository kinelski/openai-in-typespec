...
namespace OpenAI.Responses
{
    public partial class ResponseTokenUsage : IJsonModel<ResponseTokenUsage>
    {
        ...
        {
            if (responseTokenUsage == null)
            {
                return null;
            }
            return BinaryContent.Create(responseTokenUsage, ModelSerializationExtensions.WireOptions);
        }
        ...
        public static explicit operator ResponseTokenUsage(ClientResult result)
        {
            ...
            return DeserializeResponseTokenUsage(document.RootElement, ModelSerializationExtensions.WireOptions);
        }
    }
}
