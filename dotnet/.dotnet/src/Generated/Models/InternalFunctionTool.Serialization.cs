...
namespace OpenAI.Responses
{
    internal partial class InternalFunctionTool : IJsonModel<InternalFunctionTool>
    {
        ...
        public static implicit operator BinaryContent(InternalFunctionTool internalFunctionTool)
        {
            if (internalFunctionTool == null)
            {
                return null;
            }
            return BinaryContent.Create(internalFunctionTool, ModelSerializationExtensions.WireOptions);
        }

        public static explicit operator InternalFunctionTool(ClientResult result)
        {
            using PipelineResponse response = result.GetRawResponse();
            using JsonDocument document = JsonDocument.Parse(response.Content);
            return DeserializeInternalFunctionTool(document.RootElement, ModelSerializationExtensions.WireOptions);
        }
    }
}
