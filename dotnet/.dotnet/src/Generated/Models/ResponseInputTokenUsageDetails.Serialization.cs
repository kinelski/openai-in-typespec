...
namespace OpenAI.Responses
{
    public partial class ResponseInputTokenUsageDetails : IJsonModel<ResponseInputTokenUsageDetails>
    {
        ...
        {
            if (responseInputTokenUsageDetails == null)
            {
                return null;
            }
            return BinaryContent.Create(responseInputTokenUsageDetails, ModelSerializationExtensions.WireOptions);
        }
        ...
        public static explicit operator ResponseInputTokenUsageDetails(ClientResult result)
        {
            ...
            return DeserializeResponseInputTokenUsageDetails(document.RootElement, ModelSerializationExtensions.WireOptions);
        }
    }
}
