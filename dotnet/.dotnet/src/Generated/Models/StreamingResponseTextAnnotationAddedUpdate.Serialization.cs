...
namespace OpenAI.Responses
{
    ...
    {
        internal StreamingResponseTextAnnotationAddedUpdate() : this(InternalResponseStreamEventType.ResponseOutputTextAnnotationAdded, null, null, default, default, default, null)
        {
        }
