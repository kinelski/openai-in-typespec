...
namespace OpenAI.Audio
{
    public partial class StreamingAudioTranscriptionTextDeltaUpdate : IJsonModel<StreamingAudioTranscriptionTextDeltaUpdate>
    {
        ...
        {
            if (streamingAudioTranscriptionTextDeltaUpdate == null)
            {
                return null;
            }
            return BinaryContent.Create(streamingAudioTranscriptionTextDeltaUpdate, ModelSerializationExtensions.WireOptions);
        }

        public static explicit operator StreamingAudioTranscriptionTextDeltaUpdate(ClientResult result)
        {
            using PipelineResponse response = result.GetRawResponse();
            using JsonDocument document = JsonDocument.Parse(response.Content);
            return DeserializeStreamingAudioTranscriptionTextDeltaUpdate(document.RootElement, ModelSerializationExtensions.WireOptions);
        }
    }
}
