...
namespace OpenAI.Responses
{
    ...
    {
        internal InternalResponseItemList() : this(default, null, default, null, null, null)
        {
        }
        ...
        internal static InternalResponseItemList DeserializeInternalResponseItemList(JsonElement element, ModelReaderWriterOptions options)
        {
            ...
            InternalResponseItemListObject @object = default;
            ...
            foreach (var prop in element.EnumerateObject())
            {
                ...
                {
                    @object = new InternalResponseItemListObject(prop.Value.GetString());
                    continue;
                }
        ...
        public static implicit operator BinaryContent(InternalResponseItemList internalResponseItemList)
        {
            if (internalResponseItemList == null)
            {
                return null;
            }
            return BinaryContent.Create(internalResponseItemList, ModelSerializationExtensions.WireOptions);
        }
