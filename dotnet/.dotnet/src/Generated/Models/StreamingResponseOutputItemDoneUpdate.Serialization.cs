...
namespace OpenAI.Responses
{
    ...
    {
        internal StreamingResponseOutputItemDoneUpdate() : this(InternalResponseStreamEventType.ResponseOutputItemDone, null, default, null)
        {
        }
        ...
        internal static StreamingResponseOutputItemDoneUpdate DeserializeStreamingResponseOutputItemDoneUpdate(JsonElement element, ModelReaderWriterOptions options)
        {
            ...
            return new StreamingResponseOutputItemDoneUpdate(kind, additionalBinaryDataProperties, outputIndex, item);
        }
        ...
        {
            if (streamingResponseOutputItemDoneUpdate == null)
            {
                return null;
            }
            return BinaryContent.Create(streamingResponseOutputItemDoneUpdate, ModelSerializationExtensions.WireOptions);
        }

        public static explicit operator StreamingResponseOutputItemDoneUpdate(ClientResult result)
        {
            using PipelineResponse response = result.GetRawResponse();
            using JsonDocument document = JsonDocument.Parse(response.Content);
            return DeserializeStreamingResponseOutputItemDoneUpdate(document.RootElement, ModelSerializationExtensions.WireOptions);
        }
    }
}
