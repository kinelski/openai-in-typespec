...
namespace OpenAI.VectorStores
{
    internal partial class InternalStaticChunkingStrategy : IJsonModel<InternalStaticChunkingStrategy>
    {
        ...
        public static implicit operator BinaryContent(InternalStaticChunkingStrategy internalStaticChunkingStrategy)
        {
            if (internalStaticChunkingStrategy == null)
            {
                return null;
            }
            return BinaryContent.Create(internalStaticChunkingStrategy, ModelSerializationExtensions.WireOptions);
        }

        public static explicit operator InternalStaticChunkingStrategy(ClientResult result)
        {
            using PipelineResponse response = result.GetRawResponse();
            using JsonDocument document = JsonDocument.Parse(response.Content);
            return DeserializeInternalStaticChunkingStrategy(document.RootElement, ModelSerializationExtensions.WireOptions);
        }
    }
}
