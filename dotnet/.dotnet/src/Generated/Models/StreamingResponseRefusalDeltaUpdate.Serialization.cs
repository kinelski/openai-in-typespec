...
namespace OpenAI.Responses
{
    ...
    {
        internal StreamingResponseRefusalDeltaUpdate() : this(InternalResponseStreamEventType.ResponseRefusalDelta, null, null, default, default, null)
        {
        }
        ...
        {
            if (streamingResponseRefusalDeltaUpdate == null)
            {
                return null;
            }
            return BinaryContent.Create(streamingResponseRefusalDeltaUpdate, ModelSerializationExtensions.WireOptions);
        }

        public static explicit operator StreamingResponseRefusalDeltaUpdate(ClientResult result)
        {
            using PipelineResponse response = result.GetRawResponse();
            using JsonDocument document = JsonDocument.Parse(response.Content);
            return DeserializeStreamingResponseRefusalDeltaUpdate(document.RootElement, ModelSerializationExtensions.WireOptions);
        }
    }
}
