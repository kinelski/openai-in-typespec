...
{
    internal partial class InternalUnknownItem : IJsonModel<ResponseItem>
    {
        internal InternalUnknownItem() : this(default, null, null)
        {
        }
        ...
        internal static InternalUnknownItem DeserializeInternalUnknownItem(JsonElement element, ModelReaderWriterOptions options)
        {
            ...
            return new InternalUnknownItem(kind, id, additionalBinaryDataProperties);
        }
