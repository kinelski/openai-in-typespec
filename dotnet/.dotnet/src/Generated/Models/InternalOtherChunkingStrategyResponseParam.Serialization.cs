...
namespace OpenAI.VectorStores
{
    internal partial class InternalOtherChunkingStrategyResponseParam : IJsonModel<InternalOtherChunkingStrategyResponseParam>
    {
        ...
        public static implicit operator BinaryContent(InternalOtherChunkingStrategyResponseParam internalOtherChunkingStrategyResponseParam)
        {
            if (internalOtherChunkingStrategyResponseParam == null)
            {
                return null;
            }
            return BinaryContent.Create(internalOtherChunkingStrategyResponseParam, ModelSerializationExtensions.WireOptions);
        }

        public static explicit operator InternalOtherChunkingStrategyResponseParam(ClientResult result)
        {
            using PipelineResponse response = result.GetRawResponse();
            using JsonDocument document = JsonDocument.Parse(response.Content);
            return DeserializeInternalOtherChunkingStrategyResponseParam(document.RootElement, ModelSerializationExtensions.WireOptions);
        }
    }
}
