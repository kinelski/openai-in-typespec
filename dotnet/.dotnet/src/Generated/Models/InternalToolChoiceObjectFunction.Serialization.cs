...
namespace OpenAI.Responses
{
    internal partial class InternalToolChoiceObjectFunction : IJsonModel<InternalToolChoiceObjectFunction>
    {
        ...
        public static implicit operator BinaryContent(InternalToolChoiceObjectFunction internalToolChoiceObjectFunction)
        {
            if (internalToolChoiceObjectFunction == null)
            {
                return null;
            }
            return BinaryContent.Create(internalToolChoiceObjectFunction, ModelSerializationExtensions.WireOptions);
        }

        public static explicit operator InternalToolChoiceObjectFunction(ClientResult result)
        {
            using PipelineResponse response = result.GetRawResponse();
            using JsonDocument document = JsonDocument.Parse(response.Content);
            return DeserializeInternalToolChoiceObjectFunction(document.RootElement, ModelSerializationExtensions.WireOptions);
        }
    }
}
