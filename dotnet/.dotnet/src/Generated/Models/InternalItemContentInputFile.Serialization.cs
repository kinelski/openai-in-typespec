...
namespace OpenAI.Responses
{
    internal partial class InternalItemContentInputFile : IJsonModel<InternalItemContentInputFile>
    {
        ...
        public static implicit operator BinaryContent(InternalItemContentInputFile internalItemContentInputFile)
        {
            if (internalItemContentInputFile == null)
            {
                return null;
            }
            return BinaryContent.Create(internalItemContentInputFile, ModelSerializationExtensions.WireOptions);
        }

        public static explicit operator InternalItemContentInputFile(ClientResult result)
        {
            using PipelineResponse response = result.GetRawResponse();
            using JsonDocument document = JsonDocument.Parse(response.Content);
            return DeserializeInternalItemContentInputFile(document.RootElement, ModelSerializationExtensions.WireOptions);
        }
    }
}
