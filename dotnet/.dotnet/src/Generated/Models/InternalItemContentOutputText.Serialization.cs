...
namespace OpenAI.Responses
{
    ...
    {
        internal InternalItemContentOutputText() : this(InternalItemContentType.OutputText, null, null, null)
        {
        }
        ...
        internal static InternalItemContentOutputText DeserializeInternalItemContentOutputText(JsonElement element, ModelReaderWriterOptions options)
        {
            ...
            return new InternalItemContentOutputText(internalType, additionalBinaryDataProperties, annotations, internalText);
        }
        ...
        public static implicit operator BinaryContent(InternalItemContentOutputText internalItemContentOutputText)
        {
            if (internalItemContentOutputText == null)
            {
                return null;
            }
            return BinaryContent.Create(internalItemContentOutputText, ModelSerializationExtensions.WireOptions);
        }

        public static explicit operator InternalItemContentOutputText(ClientResult result)
        {
            using PipelineResponse response = result.GetRawResponse();
            using JsonDocument document = JsonDocument.Parse(response.Content);
            return DeserializeInternalItemContentOutputText(document.RootElement, ModelSerializationExtensions.WireOptions);
        }
    }
}
