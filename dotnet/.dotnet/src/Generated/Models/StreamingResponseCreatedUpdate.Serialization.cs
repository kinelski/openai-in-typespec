...
namespace OpenAI.Responses
{
    ...
    {
        internal StreamingResponseCreatedUpdate() : this(InternalResponseStreamEventType.ResponseCreated, null, null)
        {
        }
        ...
        internal static StreamingResponseCreatedUpdate DeserializeStreamingResponseCreatedUpdate(JsonElement element, ModelReaderWriterOptions options)
        {
            ...
            return new StreamingResponseCreatedUpdate(kind, additionalBinaryDataProperties, response);
        }
