...
namespace OpenAI.Responses
{
    internal partial class InternalItemContentOutputAudio : IJsonModel<InternalItemContentOutputAudio>
    {
        ...
        public static implicit operator BinaryContent(InternalItemContentOutputAudio internalItemContentOutputAudio)
        {
            if (internalItemContentOutputAudio == null)
            {
                return null;
            }
            return BinaryContent.Create(internalItemContentOutputAudio, ModelSerializationExtensions.WireOptions);
        }

        public static explicit operator InternalItemContentOutputAudio(ClientResult result)
        {
            using PipelineResponse response = result.GetRawResponse();
            using JsonDocument document = JsonDocument.Parse(response.Content);
            return DeserializeInternalItemContentOutputAudio(document.RootElement, ModelSerializationExtensions.WireOptions);
        }
    }
}
