...
{
    [PersistableModelProxy(typeof(InternalUnknownComputerToolCallOutputOutput))]
            ...
            if (element.TryGetProperty("type"u8, out JsonElement discriminator))
            {
                switch (discriminator.GetString())
                {
                    case "computer_screenshot":
                        return InternalComputerToolCallOutputOutputComputerScreenshot.DeserializeInternalComputerToolCallOutputOutputComputerScreenshot(element, options);
                }
            }
            return InternalUnknownComputerToolCallOutputOutput.DeserializeInternalUnknownComputerToolCallOutputOutput(element, options);
        }
