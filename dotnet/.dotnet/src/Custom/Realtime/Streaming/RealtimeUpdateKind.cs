...
public enum RealtimeUpdateKind
{
    ...
    ItemCreated,
    /// <summary>
    /// The <c>conversation.created</c> response command.
    /// </summary>
    [CodeGenMember("ConversationCreated")]
    ConversationCreated,
    /// <summary>
    /// The <c>conversation.item.retrieved</c> response command.
    /// </summary>
    ...
    /// <summary>
    /// The <c>conversation.item.input_audio_transcription.delta</c> response command.
    /// </summary>
    ...
    InputAudioCleared,
    /// <summary>
    /// The <c>transcription_session.created</c> response command.
    /// </summary>
    [CodeGenMember("TranscriptionSessionCreated")]
    TranscriptionSessionStarted,
    /// <summary>
    /// The <c>transcription_session.updated</c> response command.
    /// </summary>
