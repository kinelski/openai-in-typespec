...
[CodeGenSuppress("CreateTranscriptionAsync", typeof(BinaryContent), typeof(string), typeof(string), typeof(RequestOptions))]
[CodeGenSuppress("CreateTranscription", typeof(BinaryContent), typeof(string), typeof(string), typeof(RequestOptions))]
...
public partial class AudioClient
{
    ...
    public virtual async Task<ClientResult> TranscribeAudioAsync(BinaryContent content, string contentType, RequestOptions options = null)
    {
        ...
        using PipelineMessage message = CreateCreateTranscriptionRequest(content, contentType, acceptHeaderValue, options);
